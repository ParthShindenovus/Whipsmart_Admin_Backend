...
def fix_final_migration(apps, schema_editor):
    """Fix final migration - check if operations already done."""
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('knowledgebase', '0006_remove_document_knowledgeba_vector__51d840_idx_and_more'),
        migrations.swappable_dependency(settings.AUTH_USER_MODEL),
    ]

    operations = [
        migrations.RunPython(fix_final_migration, reverse_migration),
    ]
